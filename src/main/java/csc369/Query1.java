...
public class Query1 {
    ...
    public static class AccessLogMapper extends Mapper<Text, Text, Text, Text> {
        @Override
    ...
    public static class HostCountryMapper extends Mapper<LongWritable, Text, Text, Text> {
